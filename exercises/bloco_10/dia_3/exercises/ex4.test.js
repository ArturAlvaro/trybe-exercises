...
test('Função firstLetter deve retornar última letra', () => {
    strFunc.firstLetter = jest.fn().mockImplementation((str) => str.split('').reverse()[0]);
...
test('Função concatStr deve concatenar 3 strings', () => {
    strFunc.concatStr = jest.fn().mockImplementation((str1, str2, str3) => str1.concat(str2, str3));
